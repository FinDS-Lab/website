                      ...
                      {filteredMentees.map((mentee) => (
                        ...
                        >
                          <div className="flex items-center gap-12 md:gap-16">
                            <div className="relative size-36 md:size-40 rounded-full flex items-center justify-center shrink-0" style={{backgroundColor: 'rgba(255,183,197,0.2)'}}>
                              <Users size={16} style={{color: 'rgb(172,14,14)'}}/>
                              <span className="absolute -top-4 -right-4 size-18 md:size-20 bg-primary text-white text-[9px] md:text-[10px] font-bold rounded-full flex items-center justify-center">
