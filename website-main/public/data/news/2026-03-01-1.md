---
layout: default
title: "최인수 교수, 가천대학교 경영대학 금융·빅데이터학부 빅데이터경영전공 정년트랙 조교수 부임"
date: 2026-03-01
permalink: /news/2026-03-01-1.html
author: "FINDS Lab."
excerpt: "최인수 교수가 2026년 3월 1일부로 가천대학교 경영대학 금융·빅데이터학부 빅데이터경영전공 조교수로 임용되었습니다."
---
  ...
  <article class="content-card">
    <div class="content-body">
      <div class="content-text">
        <p>최인수 교수가 2026년 3월 1일자로 가천대학교 경영대학 금융·빅데이터학부 빅데이터경영전공 정년트랙 조교수로 임용되었습니다.</p>
        
        <div class="info-box">
          <h3>주요 정보</h3>
          <ul>
            <li>🎓 <strong>임용일:</strong> 2026년 3월 1일</li>
            <li>🏫 <strong>소속:</strong> 가천대학교 경영대학 금융·빅데이터학부 빅데이터경영전공</li>
            <li>👤 <strong>직급:</strong> 조교수 (정년트랙)</li>
          </ul>
        </div>
        
        <p>앞으로 가천대학교에서 학생들과 함께 의미 있는 연구와 교육 활동을 이어나갈 수 있도록 최선을 다 하겠습니다.</p>
      </div>
    </div>
