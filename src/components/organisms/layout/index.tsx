        ...
        <div className="max-w-1480 mx-auto flex items-center justify-between px-16 md:px-20 py-10">
          ...
          <Link to="/" className="flex items-center gap-12 md:gap-16">
            ...
            <div className="flex flex-col">
              <span className="text-base md:text-lg font-semibold text-gray-900">FINDS Lab</span>
              <span className="text-xs md:text-base text-gray-400 hidden sm:block">Gachon University</span>
            </div>
          </Link>
