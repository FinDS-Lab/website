          ...
          <div className="flex flex-col gap-12 md:gap-20">
            {newsItems.map((item) => (
              <div
                ...
                className="bg-white border border-gray-100 rounded-2xl p-20 md:p-28 hover:shadow-lg hover:border-primary/20 transition-all cursor-pointer group"
              >
                <div className="flex items-start gap-12 md:gap-20">
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-6 md:gap-8 mb-10 md:mb-12">
                      <span className="px-10 py-4 bg-primary/10 text-primary text-[10px] md:text-xs font-bold rounded-full">NEWS</span>
                      <span className="text-xs md:text-sm text-gray-400">{item.date}</span>
                      {item.author && (
                        <>
                          <span className="text-gray-300 hidden sm:block">·</span>
                          <span className="text-xs md:text-sm text-gray-400 hidden sm:block">{item.author}</span>
                        </>
                      )}
                    </div>
