...
const tagColors: Record<NewsTag, { bg: string; text: string; border: string; hoverText: string }> = {
  ...
  'Awards': { bg: 'bg-[#D6A076]/10', text: 'text-[#B8762D]', border: 'border-[#D6A076]/30', hoverText: '#B8762D' },
  'Events': { bg: 'bg-[#AC0E0E]/10', text: 'text-[#AC0E0E]', border: 'border-[#AC0E0E]/30', hoverText: '#AC0E0E' },
