    ...
    return (
      <div className="flex items-center justify-center py-80">
        <div className="flex flex-col items-center gap-16">
          <div className="w-40 h-40 border-3 border-[#D6B04C] border-t-transparent rounded-full animate-spin" />
    ...
    <article className="relative">
      ...
      <header className="relative mb-32 md:mb-48 pb-32 md:pb-40 border-b border-gray-100">
        ...
        <div className="flex items-center gap-12 mb-20 md:mb-24">
          <span className="px-12 py-4 bg-gradient-to-r from-[#D6B04C] to-[#D6C360] text-white text-[10px] md:text-xs font-bold uppercase tracking-wider rounded-full">
            News
          </span>
          <div className="h-4 w-px bg-gray-200" />
          <span className="text-xs md:text-sm text-gray-400 font-medium">{metadata.author}</span>
        </div>
        ...
        <div className="flex items-center gap-16">
          <div className="flex items-center gap-8">
            <Calendar className="size-16 text-[#D6B04C]" />
            <time className="text-sm md:text-base font-medium text-gray-500">{metadata.date}</time>
          </div>
        </div>
        
        {/* Decorative Line */}
        <div className="absolute bottom-0 left-0 w-80 h-[3px] bg-gradient-to-r from-[#D6B04C] to-transparent rounded-full" />
      </header>
      ...
      <div 
        className="prose prose-lg max-w-none
          ...
          prose-a:text-[#D6B04C] prose-a:font-medium prose-a:no-underline hover:prose-a:underline
          prose-strong:text-gray-800 prose-strong:font-semibold
          prose-ul:my-20 prose-li:text-gray-600 prose-li:text-sm prose-li:md:text-base
          prose-blockquote:border-l-4 prose-blockquote:border-[#D6B04C] prose-blockquote:bg-[#FFF9E6] prose-blockquote:py-16 prose-blockquote:px-20 prose-blockquote:rounded-r-lg prose-blockquote:not-italic
      ...
      <footer className="mt-40 md:mt-60 pt-24 md:pt-32 border-t border-gray-100">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-12">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#D6B04C] to-[#D6C360]" />
            <span className="text-xs md:text-sm font-medium text-gray-400">FINDS Lab. News</span>
          </div>
