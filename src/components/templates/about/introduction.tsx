                  ...
                  {goalLang === 'ko' ? (
                    <>
                      <p className="text-sm md:text-lg leading-[2] text-gray-400">
                        가천대학교 경영대학 금융·빅데이터학부 빅데이터경영전공<br className="hidden md:block" /> <span className="font-bold" style={{color: '#D6B14D'}}>금융데이터인텔리전스</span> 연구실(<span className="font-bold" style={{color: '#D6B14D'}}>FINDS</span> Lab)은<br className="hidden md:block" /> <span className="font-semibold text-white">데이터 중심</span>으로 급변하는 <span className="font-semibold text-white">경영 환경</span>과 <span className="font-semibold text-white">금융 시장</span>을 비롯한<br className="hidden md:block" /> 산업 현장에서 <span className="font-bold" style={{color: '#D6B14D'}}>실질적인 가치 창출</span>을 목표로 합니다.
                      </p>
                      <p className="text-sm md:text-lg leading-[2] text-gray-400">
                        저희 <span className="font-semibold text-white">FINDS Lab</span>은 <span className="font-bold" style={{ color: '#D6B14D', textShadow: '0 0 20px rgba(214, 177, 77, 0.3)' }}>데이터 사이언스</span>와 <span className="font-bold" style={{ color: '#D6B14D', textShadow: '0 0 20px rgba(214, 177, 77, 0.3)' }}>비즈니스 애널리틱스</span> 기법을 활용하여<br className="hidden md:block" /> 복잡한 데이터 속에서 유의미한 <span className="font-bold" style={{color: '#D6B14D'}}>finds, 발견</span>을 이끌어내고,<br className="hidden md:block" /> 이를 통해 <span className="font-semibold text-white">경영 환경</span>과 <span className="font-semibold text-white">산업 현장</span>을 <span className="font-bold" style={{color: '#D6B14D'}}>다각도로 개선</span>하는 데 기여하고자 합니다.
                      </p>
                      <p className="text-sm md:text-lg leading-[2] text-gray-400">
                        특히 <span className="font-bold text-white">지식과 정보의 비대칭</span>으로 발생하는 <span className="font-bold" style={{ color: 'rgb(214, 177, 77)', textShadow: '0 0 20px rgba(214, 177, 77, 0.3)' }}>사회적 비효율을 극복</span>하고,<br className="hidden md:block" /> 데이터를 <span className="font-bold" style={{ color: 'rgb(214, 177, 77)', textShadow: '0 0 20px rgba(214, 177, 77, 0.3)' }}>전략적 인사이트</span>로 전환함으로써 <span className="font-semibold text-white">경영 효율성</span>을 제고하여<br className="hidden md:block" /> <span className="font-bold" style={{ color: 'rgb(214, 177, 77)', textShadow: '0 0 20px rgba(214, 177, 77, 0.3)' }}>더 나은 내일</span>을 만드는 데 앞장서겠습니다.
                      </p>
                    </>
                  ) : (
                    <>
                      <p className="text-sm md:text-lg leading-[2] text-gray-400">
                        The <span className="font-bold" style={{color: '#D6B14D'}}>Financial Data Intelligence</span> & Solutions Laboratory (<span className="font-bold" style={{color: '#D6B14D'}}>FINDS</span> Lab)<br className="hidden md:block" /> at Gachon University conducts research that aims for <span className="font-bold" style={{color: '#D6B14D'}}>tangible value creation</span><br className="hidden md:block" /> in the rapidly evolving, <span className="font-semibold text-white">data-informed</span> <span className="font-semibold text-white">business environments</span> and <span className="font-semibold text-white">financial markets</span>.
                      </p>
                      <p className="text-sm md:text-lg leading-[2] text-gray-400">
                        Our <span className="font-semibold text-white">FINDS Lab</span> utilizes <span className="font-bold" style={{ color: '#D6B14D', textShadow: '0 0 20px rgba(214, 177, 77, 0.3)' }}>data science</span> and <span className="font-bold" style={{ color: '#D6B14D', textShadow: '0 0 20px rgba(214, 177, 77, 0.3)' }}>business analytics</span><br className="hidden md:block" /> to derive meaningful <span className="font-bold" style={{color: '#D6B14D'}}>finds</span> from complex data,<br className="hidden md:block" /> contributing to the <span className="font-bold" style={{color: '#D6B14D'}}>iridescent insights</span> of <span className="font-semibold text-white">business environments</span> and <span className="font-semibold text-white">industrial sectors</span>.
                      </p>
                      <p className="text-sm md:text-lg leading-[2] text-gray-400">
                        In particular, we strive to <span className="font-bold" style={{ color: 'rgb(214, 177, 77)', textShadow: '0 0 20px rgba(214, 177, 77, 0.3)' }}>overcome social inefficiencies</span><br className="hidden md:block" /> arising from <span className="font-bold text-white">asymmetries in knowledge and information</span>.<br className="hidden md:block" /> By transforming data into <span className="font-bold" style={{ color: 'rgb(214, 177, 77)', textShadow: '0 0 20px rgba(214, 177, 77, 0.3)' }}>strategic insights</span>, we will lead the way<br className="hidden md:block" /> in <span className="font-semibold text-white">enhancing management efficiency</span> to build a <span className="font-bold" style={{ color: 'rgb(214, 177, 77)', textShadow: '0 0 20px rgba(214, 177, 77, 0.3)' }}>better tomorrow</span>.
                      </p>
                    </>
                  )}
                </div>
