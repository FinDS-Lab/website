                ...
                <div className="p-20 md:p-24 border-t border-gray-100">
                  <div className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-8 md:gap-12 mb-16 md:mb-24">
                    {pubStats.map((stat, index) => {
                      const hoverColor = stat.label === 'SCIE' || stat.label === 'SSCI' || stat.label === 'A&HCI' ? 'hover:bg-[#D6B14D]/5' : stat.label === 'ESCI' || stat.label === 'Scopus' ? 'hover:bg-[#D6C360]/5' : stat.label === 'Other Int\'l' ? 'hover:bg-[#E8D688]/10' : stat.label === 'Int\'l Conf' ? 'hover:bg-[#E8889C]/5' : stat.label === 'Dom. Conf' ? 'hover:bg-[#D6A076]/5' : stat.label === 'KCI' ? 'hover:bg-[#64748b]/5' : 'hover:bg-[#D6B14D]/5'
                      const textColor = stat.label === 'SCIE' || stat.label === 'SSCI' || stat.label === 'A&HCI' ? 'text-[#D6B14D]' : stat.label === 'ESCI' || stat.label === 'Scopus' ? 'text-[#D6C360]' : stat.label === 'Other Int\'l' ? 'text-[#9A7D1F]' : stat.label === 'Int\'l Conf' ? 'text-[#E8889C]' : stat.label === 'Dom. Conf' ? 'text-[#D6A076]' : stat.label === 'KCI' ? 'text-[#64748b]' : 'text-primary'
                      return (
